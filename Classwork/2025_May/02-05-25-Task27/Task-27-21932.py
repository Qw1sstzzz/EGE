...
with open('Task-27A-21932-file.txt') as f:
...
with open('Task-27B-21932-file.txt') as f:
...
PxA = centersA[1][0] * 10_000
PyA = centersA[0][1] * 10_000
PxB = centersB[2][0] * 10_000
PyB = centersB[1][1] * 10_000
